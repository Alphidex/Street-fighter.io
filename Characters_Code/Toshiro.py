...
class Toshiro(Fighter):
    ...
    def get_attack_data(self):
        data = {
            "normal_attack": {"trigger": False, "cooldown": 100, "frame_index": 2, "damage": 1.4, "knockback": 1,
                              "action": 17, "range_attack": False,
                              "rect": pygame.Rect(self.rect.centerx - 30 - (120 * self.flip),
                                                  self.rect.y - 20, 180, 25 + self.rect.height)},
            "normal_attack_up": {"trigger": False, "cooldown": 100, "frame_index": 2, "damage": 1.6, "knockback": 1,
            ...
            "normal_attack_down": {"trigger": False, "cooldown": 100, "frame_index": 4 <= self.frame_index <= 6,
                                   "damage": 0.75, "knockback": 0.7, "action": 8, "range_attack": False,
                                   "rect": pygame.Rect(self.rect.centerx - 110,
                                                       self.rect.y + 20, 220, 140)},
            "normal_jump_attack": {"trigger": False, "cooldown": 100, "frame_index": 2, "damage": 1.7, "knockback": 1,
