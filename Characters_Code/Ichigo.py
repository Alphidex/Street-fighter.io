...
class Ichigo(Fighter):
    ...
    def get_attack_data(self):
        data = {
            ...
            "normal_attack_up": {"trigger": False, "cooldown": 75, "frame_index": 2, "damage": 1.9, "knockback": 1,
            ...
            "strong_attack": {"trigger": False, "cooldown": 90, "frame_index": 4 <= self.frame_index <= 10, "damage": 6,
