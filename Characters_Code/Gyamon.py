...
class Gyamon(Fighter):
    ...
    def get_attack_data(self):
        data = {
            ...
            "special_attack": {"trigger": False, "cooldown": 100, "frame_index": 8<= self.frame_index<= 25, "damage": 1.7, "knockback": 1, "action": 0, "range_attack":False, "rect": pygame.Rect(self.rect.centerx - (3.4 * self.rect.width * self.flip),self.rect.y * 0.9, 3.4 * self.rect.width,1.5 * self.rect.height)},
